{
  ...
  version = "1.11.2";
  system = "x86_64-linux";
  devenv_root = "/home/chris/Dokumente/Projekte/Tipinuss";
  project_input_ref = "path:/home/chris/Dokumente/Projekte/Tipinuss";
  devenv_dotfile = "/home/chris/Dokumente/Projekte/Tipinuss/.devenv";
  devenv_dotfile_path = ./.devenv;
  devenv_tmpdir = "/run/user/1000";
  devenv_runtime = "/run/user/1000/devenv-ec48fad";
  devenv_istesting = false;
  devenv_direnvrc_latest_version = 1;
  container_name = null;
  active_profiles = [
  ];
  hostname = "desktop-chris-fedora";
  username = "chris";
  git_root = "/home/chris/Dokumente/Projekte/Tipinuss";
  secretspec = null;
};
    in
    {
