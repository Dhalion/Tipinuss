<div class="min-h-screen flex items-center justify-center bg-zinc-50 dark:bg-zinc-900 px-4">
    <flux:card class="w-full max-w-md">
        ...
        <form wire:submit="register" class="space-y-4">
            ...
            @error('name') <div class="text-sm text-tipinuss-red-600">{{ $message }}</div> @enderror
            ...
            @error('password_confirmation') <div class="text-sm text-tipinuss-red-600">{{ $message }}</div> @enderror
